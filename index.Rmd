...
fig <- fig %>% layout(yaxis = list(title = 'Messages Count'), barmode = 'group')
fig
```
...
### Package Translation Completed | <small> Respective Languages </small>
...
### Package Translation Not Started | <small> Respective Languages </small>
